      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-white/70 mt-2">
            Manage and view all your property visit bookings
          </p>
        </div>
      </motion.section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
        ...
        >
          <div className="relative max-w-2xl">
            ...
            />
            <FaCalendar className="absolute left-4 top-1/2 -translate-y-1/2 text-neutral-400 w-4 h-4" />
            {filter && (
              <button
                onClick={() => setFilter("")}
        ...
        {filteredBookings.length > 0 ? (
          ...
          <EmptyState
            ...
            description="Try adjusting your search terms to find your bookings."
            actionLabel="Clear Search"
            onAction={() => setFilter("")}
          />
        ) : (
          <EmptyState type="bookings" onAction={() => navigate("/listing")} />
        )}
