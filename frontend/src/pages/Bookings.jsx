...
import { FaCalendar, FaMapMarkerAlt, FaStar, FaCrown, FaBed, FaBath, FaRulerCombined } from 'react-icons/fa';
        ...
        <div className="">
          ...
          {data?.length === 0 && (
            <div className="text-center py-10">
              <p className="text-lg text-gray-600">No bookings found. Start booking properties!</p>
            </div>
          )}
        </div>
      </div>
